...
class UpsData(u: Ups): Observer, Subject() {
    ...
    companion object{
        ...
        val allAlarms: Map<String, Alarm> = mapOf(
            "A000" to Alarm("A000", R.string.a000,Alarm.Level.CRITICAL),
            "A001" to Alarm("A001", R.string.a001,Alarm.Level.CRITICAL),
            "A002" to Alarm("A002", R.string.a002,Alarm.Level.WARNING),
            "A003" to Alarm("A003", R.string.a003,Alarm.Level.WARNING),
            "A004" to Alarm("A004", R.string.a004,Alarm.Level.WARNING),
            "A005" to Alarm("A005", R.string.a005,Alarm.Level.WARNING),
            "A006" to Alarm("A006", R.string.a006,Alarm.Level.WARNING),
            "A007" to Alarm("A007", R.string.a007,Alarm.Level.NONE),
            "A008" to Alarm("A008", R.string.a008,Alarm.Level.WARNING),
            "A009" to Alarm("A009", R.string.a009,Alarm.Level.WARNING),
            "A010" to Alarm("A010", R.string.a010,Alarm.Level.WARNING),
            "A011" to Alarm("A011", R.string.a011,Alarm.Level.NONE),
            "A012" to Alarm("A012", R.string.a012,Alarm.Level.CRITICAL),
            "A013" to Alarm("A013", R.string.a013,Alarm.Level.WARNING),
            "A014" to Alarm("A014", R.string.a014,Alarm.Level.WARNING),
            "A015" to Alarm("A015", R.string.a015,Alarm.Level.WARNING),
            "A016" to Alarm("A016", R.string.a016,Alarm.Level.CRITICAL),
            "A017" to Alarm("A017", R.string.a017,Alarm.Level.CRITICAL),
            "A018" to Alarm("A018", R.string.a018,Alarm.Level.CRITICAL),
            "A019" to Alarm("A019", R.string.a019,Alarm.Level.WARNING),
            "A020" to Alarm("A020", R.string.a020,Alarm.Level.CRITICAL),
            "A021" to Alarm("A021", R.string.a021,Alarm.Level.CRITICAL),
            "A022" to Alarm("A022", R.string.a022,Alarm.Level.WARNING),
            "A023" to Alarm("A023", R.string.a023,Alarm.Level.WARNING),
            "A024" to Alarm("A024", R.string.a024,Alarm.Level.WARNING),
            "A025" to Alarm("A025", R.string.a025,Alarm.Level.WARNING),
            "A026" to Alarm("A026", R.string.a026,Alarm.Level.WARNING),
            "A027" to Alarm("A027", R.string.a027,Alarm.Level.CRITICAL),
            "A028" to Alarm("A028", R.string.a028,Alarm.Level.WARNING),
            "A029" to Alarm("A029", R.string.a029,Alarm.Level.CRITICAL),
            "A030" to Alarm("A030", R.string.a030,Alarm.Level.WARNING),
            "A031" to Alarm("A031", R.string.a031,Alarm.Level.WARNING),
            "A032" to Alarm("A032", R.string.a032,Alarm.Level.CRITICAL),
            "A033" to Alarm("A033", R.string.a033,Alarm.Level.WARNING),
            "A034" to Alarm("A034", R.string.a034,Alarm.Level.WARNING),
            "A035" to Alarm("A035", R.string.a035,Alarm.Level.WARNING),
            "A036" to Alarm("A036", R.string.a036,Alarm.Level.WARNING),
            "A037" to Alarm("A037", R.string.a037,Alarm.Level.CRITICAL),
            "A038" to Alarm("A038", R.string.a038,Alarm.Level.WARNING),
            "A039" to Alarm("A039", R.string.a039,Alarm.Level.NONE),
            "A040" to Alarm("A040", R.string.a040,Alarm.Level.CRITICAL),
            "A041" to Alarm("A041", R.string.a041,Alarm.Level.WARNING),
            "A042" to Alarm("A042", R.string.a042,Alarm.Level.WARNING),
            "A043" to Alarm("A043", R.string.a043,Alarm.Level.NONE),
            "A044" to Alarm("A044", R.string.a044,Alarm.Level.NONE),
            "A045" to Alarm("A045", R.string.a045,Alarm.Level.WARNING),
            "A046" to Alarm("A046", R.string.a046,Alarm.Level.CRITICAL),
            "A047" to Alarm("A047", R.string.a047,Alarm.Level.WARNING),
            "A048" to Alarm("A048", R.string.a048,Alarm.Level.CRITICAL),
            "A049" to Alarm("A049", R.string.a049,Alarm.Level.WARNING),
            "A050" to Alarm("A050", R.string.a050,Alarm.Level.WARNING),
            "A051" to Alarm("A051", R.string.a051,Alarm.Level.WARNING),
            "A052" to Alarm("A052", R.string.a052,Alarm.Level.WARNING),
            "A053" to Alarm("A053", R.string.a053,Alarm.Level.WARNING),
            "A054" to Alarm("A054", R.string.a054,Alarm.Level.WARNING),
            "A055" to Alarm("A055", R.string.a055,Alarm.Level.WARNING),
            "A056" to Alarm("A056", R.string.a056,Alarm.Level.WARNING),
            "A057" to Alarm("A057", R.string.a057,Alarm.Level.WARNING),
            "A058" to Alarm("A058", R.string.a058,Alarm.Level.WARNING),
            "A059" to Alarm("A059", R.string.a059,Alarm.Level.CRITICAL),
            "A060" to Alarm("A060", R.string.a060,Alarm.Level.WARNING),
            "A061" to Alarm("A061", R.string.a061,Alarm.Level.WARNING),
            "A062" to Alarm("A062", R.string.a062,Alarm.Level.WARNING),
            ...
            "A072" to Alarm("A072", R.string.a072,Alarm.Level.WARNING),
            ...
            "A080" to Alarm("A080", R.string.a080,Alarm.Level.CRITICAL),
